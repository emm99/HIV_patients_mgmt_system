...
<div class="ma-12 pa-12">
    ...
    >
      ...
      <v-toolbar-title>Nurse's Dashboard</v-toolbar-title>
      <v-spacer></v-spacer>
...
export default {
    ...
    data: () => ({
      ...
      patients: [
        {title:'New Patient',icon:'mdi-account-multiple-plus', to:'/nurse/newpatient/'},
      ],

      reports: [
          {title:'Reports',icon:'mdi-chart-bar',to:'/nurse/report' }
      ],
     dashboards: [
          {icon:'mdi-view-dashboard',to:'/nurse/dashboard' }
       ]
    }),
    created(){
      EventBus.$on('logout', () => {
